...
# add for non-tax drinks

def is_tax_drink(item_description):
    drinks = ['coke', 'pepsi', 'snapple', 'fanta', 'dr\.pepper', 'sprite', 'sunkist', 'prigot', 'spring', "ginger ale", "malt", "beer", "schweeps"]
        ...
        if receipt.fields.get("Items"):
            ...
            for item_idx, item in enumerate(receipt.fields.get("Items").value):
                ...
                if item_description:
                    ...
                    if is_tax_drink( item_description.value.lower() ):
                        my_item.category = 'tax-drink'
